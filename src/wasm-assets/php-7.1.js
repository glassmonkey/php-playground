export const dependenciesTotalSize = 4369639;
export const dependencyFilename =
	'php-7.1.wasm?bb86942ec908bb3c585fa7eece4c3cce';
export default function (RuntimeName, PHPLoader, EnvVariables) {
	...
	function assignWasmExports(wasmExports) {
		_wasm_popen = Module['_wasm_popen'] = wasmExports['Ia'];
		_wasm_pclose = Module['_wasm_pclose'] = wasmExports['Ja'];
		_php_pollfd_for = Module['_php_pollfd_for'] = wasmExports['Ka'];
		_malloc = wasmExports['Ma'];
		_ntohs = wasmExports['Na'];
		_htons = wasmExports['Oa'];
		...
		_wasm_set_php_code = Module['_wasm_set_php_code'] = wasmExports['cb'];
		...
		_exec_callback = Module['_exec_callback'] = wasmExports['jb'];
		_del_callback = Module['_del_callback'] = wasmExports['kb'];
		___funcs_on_exit = wasmExports['lb'];
		_emscripten_builtin_memalign = wasmExports['mb'];
		__emscripten_timeout = wasmExports['nb'];
		_setThrew = wasmExports['ob'];
		__emscripten_stack_restore = wasmExports['pb'];
		__emscripten_stack_alloc = wasmExports['qb'];
		_emscripten_stack_get_current = wasmExports['rb'];
		dynCall_viii = wasmExports['sb'];
		dynCall_vii = wasmExports['tb'];
		dynCall_vi = wasmExports['ub'];
		dynCall_iii = wasmExports['vb'];
		dynCall_ii = wasmExports['wb'];
		dynCall_v = wasmExports['xb'];
		dynCall_iiii = wasmExports['yb'];
		dynCall_viiiii = wasmExports['zb'];
		dynCall_iiiii = wasmExports['Ab'];
		dynCall_iiiiiii = wasmExports['Bb'];
		dynCall_iiiiii = wasmExports['dynCall_iiiiii'];
		dynCall_i = wasmExports['Cb'];
		...
		dynCall_viiiiii = wasmExports['Eb'];
