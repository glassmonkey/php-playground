export const dependenciesTotalSize = 4222016;
export const dependencyFilename =
	'php-5.6.wasm?9c49a0e85544bf35b86902aedbc5f231';
export default function (RuntimeName, PHPLoader, EnvVariables) {
	...
	function assignWasmExports(wasmExports) {
		_wasm_popen = Module['_wasm_popen'] = wasmExports['Ka'];
		_wasm_pclose = Module['_wasm_pclose'] = wasmExports['La'];
		_php_pollfd_for = Module['_php_pollfd_for'] = wasmExports['Ma'];
		_malloc = wasmExports['Na'];
		_ntohs = wasmExports['Pa'];
		_htons = wasmExports['Qa'];
		_fflush = wasmExports['Ra'];
		...
		_wasm_set_php_code = Module['_wasm_set_php_code'] = wasmExports['eb'];
		...
		_exec_callback = Module['_exec_callback'] = wasmExports['lb'];
		_del_callback = Module['_del_callback'] = wasmExports['mb'];
		___funcs_on_exit = wasmExports['nb'];
		_emscripten_builtin_memalign = wasmExports['ob'];
		__emscripten_timeout = wasmExports['pb'];
		_setThrew = wasmExports['qb'];
		__emscripten_stack_restore = wasmExports['rb'];
		__emscripten_stack_alloc = wasmExports['sb'];
		_emscripten_stack_get_current = wasmExports['tb'];
		dynCall_viii = wasmExports['ub'];
		dynCall_vi = wasmExports['vb'];
		dynCall_ii = wasmExports['wb'];
		dynCall_iii = wasmExports['xb'];
		dynCall_iiii = wasmExports['yb'];
		dynCall_v = wasmExports['zb'];
		dynCall_iiiii = wasmExports['Ab'];
		dynCall_iiiiii = wasmExports['dynCall_iiiiii'];
		dynCall_vii = wasmExports['Bb'];
		dynCall_viiii = wasmExports['Cb'];
		dynCall_iiiiiii = wasmExports['Db'];
		dynCall_i = wasmExports['Eb'];
		dynCall_viiiii = wasmExports['Fb'];
		dynCall_iiiiiiii = wasmExports['Gb'];
		dynCall_iijii = wasmExports['dynCall_iijii'];
		dynCall_iiiiiiiii = wasmExports['Hb'];
		dynCall_viiiiiiii = wasmExports['dynCall_viiiiiiii'];
		dynCall_iiiiiiiiii = wasmExports['dynCall_iiiiiiiiii'];
		dynCall_viiiiii = wasmExports['Ib'];
		dynCall_jiji = wasmExports['dynCall_jiji'];
		dynCall_iidiiii = wasmExports['dynCall_iidiiii'];
		memory = wasmMemory = wasmExports['Ia'];
		__indirect_function_table = wasmTable = wasmExports['Oa'];
	}
	var wasmImports = {
		p: ___assert_fail,
		Y: ___call_sighandler,
		T: ___syscall__newselect,
		...
		S: ___syscall_statfs64,
		R: ___syscall_symlinkat,
		P: ___syscall_unlinkat,
		O: ___syscall_utimensat,
		_: __abort_js,
		I: __emscripten_lookup_name,
