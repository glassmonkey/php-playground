export const dependenciesTotalSize = 4548611;
export const dependencyFilename =
	'php-8.0.wasm?186c9955b548e253bff6ad7959cb9e97';
export default function (RuntimeName, PHPLoader, EnvVariables) {
	...
	var wasmImports = {
		s: ___assert_fail,
		ka: ___call_sighandler,
		fa: ___syscall__newselect,
		...
		V: ___syscall_getpeername,
		U: ___syscall_getsockname,
		T: ___syscall_getsockopt,
		E: ___syscall_ioctl,
		S: ___syscall_listen,
		...
		R: ___syscall_recvfrom,
		ha: ___syscall_renameat,
		ga: ___syscall_rmdir,
		Q: ___syscall_sendto,
		y: ___syscall_socket,
		sa: ___syscall_stat64,
		ea: ___syscall_statfs64,
		da: ___syscall_symlink,
	...
	var _wasm_popen = (Module['_wasm_popen'] = (a0, a1) =>
		(_wasm_popen = Module['_wasm_popen'] = wasmExports['Oa'])(a0, a1));
	var ___errno_location = () => (___errno_location = wasmExports['Pa'])();
	var _wasm_pclose = (Module['_wasm_pclose'] = (a0) =>
		(_wasm_pclose = Module['_wasm_pclose'] = wasmExports['Qa'])(a0));
	var _php_pollfd_for = (Module['_php_pollfd_for'] = (a0, a1, a2) =>
		(_php_pollfd_for = Module['_php_pollfd_for'] = wasmExports['Ra'])(
			a0,
			a1,
			a2
		));
	var _memcpy = (a0, a1, a2) => (_memcpy = wasmExports['Sa'])(a0, a1, a2);
	var _free = (a0) => (_free = wasmExports['Ta'])(a0);
	...
	var _ntohs = (a0) => (_ntohs = wasmExports['Za'])(a0);
	var _htonl = (a0) => (_htonl = wasmExports['_a'])(a0);
	...
	var _wasm_add_uploaded_file = (Module['_wasm_add_uploaded_file'] = (
		...
		(_wasm_add_uploaded_file = Module['_wasm_add_uploaded_file'] =
			wasmExports['cb'])(a0, a1, a2, a3, a4, a5));
	...
	var _wasm_set_php_code = (Module['_wasm_set_php_code'] = (a0) =>
		(_wasm_set_php_code = Module['_wasm_set_php_code'] = wasmExports['nb'])(
			a0
		));
	...
	var _exec_callback = (Module['_exec_callback'] = (a0) =>
		(_exec_callback = Module['_exec_callback'] = wasmExports['ub'])(a0));
	var _del_callback = (Module['_del_callback'] = (a0) =>
		(_del_callback = Module['_del_callback'] = wasmExports['vb'])(a0));
	...
	var stackSave = () => (stackSave = wasmExports['Ab'])();
	var stackRestore = (a0) => (stackRestore = wasmExports['Bb'])(a0);
	var stackAlloc = (a0) => (stackAlloc = wasmExports['Cb'])(a0);
