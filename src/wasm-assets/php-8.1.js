export const dependenciesTotalSize = 3565242;
export const dependencyFilename =
	'php-8.1.wasm?bb659d03175164542950c9f545eb5f5e';
export default function (RuntimeName, PHPLoader, EnvVariables) {
	...
	var _emscripten_builtin_memalign = function () {
		return (_emscripten_builtin_memalign = Module['asm']['Bb']).apply(
			null,
			arguments
		);
	};
	var __emscripten_timeout = function () {
		return (__emscripten_timeout = Module['asm']['Cb']).apply(
			null,
			arguments
		);
	};
