    ...
    <main style={{ margin: "16px" }}>
      <Flex marginTop="8px" marginBottom="8px" gap="16px">
        <Box marginLeft="16px" marginTop="auto" marginBottom="auto">
          ...
          >
            <Flex>
              <img src="octocat.png" width="40px" height="40px" style={{ marginTop: "auto", marginBottom: "auto" }} />
              <Text fontSize="sm" style={{ marginTop: "auto", marginBottom: "auto" }}>&lt; Feature Request and Bug
                Report</Text>
            </Flex>
          </a>
        </Box>
