export const dependenciesTotalSize = 3813599;
export const dependencyFilename =
	'php-7.2.wasm?6fcc815a7673a1824cd74ba192fabd46';
export default function (RuntimeName, PHPLoader, EnvVariables) {
	...
	var dynCall_i = (Module['dynCall_i'] = function () {
		return (dynCall_i = Module['dynCall_i'] = Module['asm']['Fb']).apply(
			null,
			arguments
		);
	});
	...
	var dynCall_v = (Module['dynCall_v'] = function () {
		return (dynCall_v = Module['dynCall_v'] = Module['asm']['Jb']).apply(
			null,
			arguments
		);
	});
