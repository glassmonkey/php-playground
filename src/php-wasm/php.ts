...
/**
 * Type definition for PHP WASM loader module
 * Based on the ESM module generated by the Dockerfile
 */
...
/**
 * Emscripten module arguments
 * See: https://emscripten.org/docs/api_reference/module.html#affecting-execution
 */
export interface EmscriptenModuleArgs {
	onAbort?: (reason: string | Error) => void;
...
export interface EmscriptenPHPModule {
	...
	monitorRunDependencies?: (nbLeft: number) => void;
	[key: string]: unknown;
}

/**
 * Data dependency module
 */
export interface DataDependencyModule {
	dependenciesTotalSize: number;
	dependencyFilename: string;
	default: (phpModule: EmscriptenPHPModule) => void;
}
...
export async function startPHP(
	...
	phpModuleArgs: EmscriptenModuleArgs = {},
	dataDependenciesModules: DataDependencyModule[] = []
): Promise<PHP> {
...
export class PHP {
	 ...
	 */
	constructor(version: Version, PHPRuntime: EmscriptenPHPModule) {
