export const dependenciesTotalSize = 4223111;
export const dependencyFilename =
	'php-5.6.wasm?cce2d99ab4dcc8fc5f752d77eaf27327';
export default function (RuntimeName, PHPLoader, EnvVariables) {
	...
	var wasmImports = {
		...
		Q: ___syscall_getpeername,
		P: ___syscall_getsockname,
		O: ___syscall_getsockopt,
		za: ___syscall_ioctl,
		N: ___syscall_listen,
		...
		W: ___syscall_utimensat,
		ra: __emscripten_get_now_is_monotonic,
		ga: __emscripten_runtime_keepalive_clear,
		...
		n: _strftime,
		Fa: _strptime,
		Ca: _vrzno_del_callback,
		Da: _vrzno_exec_callback,
		D: _wasm_poll_socket,
		Ga: _wasm_setsockopt,
	};
	...
	var setTempRet0 = (a0) => (setTempRet0 = wasmExports['Ta'])(a0);
	var _ntohs = (a0) => (_ntohs = wasmExports['Ua'])(a0);
	var _htons = (a0) => (_htons = wasmExports['Va'])(a0);
	...
	var _wasm_add_uploaded_file = (Module['_wasm_add_uploaded_file'] = (
		...
		(_wasm_add_uploaded_file = Module['_wasm_add_uploaded_file'] =
			wasmExports['_a'])(a0, a1, a2, a3, a4, a5));
	...
	var _wasm_set_php_code = (Module['_wasm_set_php_code'] = (a0) =>
		(_wasm_set_php_code = Module['_wasm_set_php_code'] = wasmExports['jb'])(
			a0
		));
	...
	var _exec_callback = (Module['_exec_callback'] = (a0) =>
		(_exec_callback = Module['_exec_callback'] = wasmExports['qb'])(a0));
	var _del_callback = (Module['_del_callback'] = (a0) =>
		(_del_callback = Module['_del_callback'] = wasmExports['rb'])(a0));
	...
	var stackSave = () => (stackSave = wasmExports['wb'])();
	var stackRestore = (a0) => (stackRestore = wasmExports['xb'])(a0);
	var stackAlloc = (a0) => (stackAlloc = wasmExports['yb'])(a0);
	...
	var dynCall_ii = (Module['dynCall_ii'] = (a0, a1) =>
		(dynCall_ii = Module['dynCall_ii'] = wasmExports['Bb'])(a0, a1));
	...
	var dynCall_v = (Module['dynCall_v'] = (a0) =>
		(dynCall_v = Module['dynCall_v'] = wasmExports['Eb'])(a0));
	...
	var dynCall_viiii = (Module['dynCall_viiii'] = (a0, a1, a2, a3, a4) =>
		(dynCall_viiii = Module['dynCall_viiii'] = wasmExports['Hb'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_i = (Module['dynCall_i'] = (a0) =>
		(dynCall_i = Module['dynCall_i'] = wasmExports['Jb'])(a0));
	...
	var dynCall_iiiiiiii = (Module['dynCall_iiiiiiii'] = (
		...
		(dynCall_iiiiiiii = Module['dynCall_iiiiiiii'] = wasmExports['Lb'])(
			a0,
			a1,
			a2,
			a3,
	...
	var dynCall_iiiiiiiii = (Module['dynCall_iiiiiiiii'] = (
		...
		(dynCall_iiiiiiiii = Module['dynCall_iiiiiiiii'] = wasmExports['Mb'])(
			a0,
			a1,
			a2,
			a3,
