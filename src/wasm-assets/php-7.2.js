export const dependenciesTotalSize = 4478604;
export const dependencyFilename =
	'php-7.2.wasm?4c0a85fdcf6392f1aa206edd59d31654';
export default function (RuntimeName, PHPLoader, EnvVariables) {
	...
	function assignWasmExports(wasmExports) {
		...
		dynCall_vi = wasmExports['tb'];
		dynCall_iiii = wasmExports['ub'];
		dynCall_ii = wasmExports['vb'];
		dynCall_viiiii = wasmExports['wb'];
		dynCall_iii = wasmExports['xb'];
		dynCall_iiiii = wasmExports['yb'];
		dynCall_iiiiiii = wasmExports['zb'];
		dynCall_iiiiii = wasmExports['dynCall_iiiiii'];
		dynCall_i = wasmExports['Ab'];
		dynCall_viii = wasmExports['Bb'];
		dynCall_vii = wasmExports['Cb'];
		dynCall_viiii = wasmExports['Db'];
		dynCall_v = wasmExports['Eb'];
		dynCall_viiiiiiii = wasmExports['dynCall_viiiiiiii'];
		dynCall_iiiiiiiiii = wasmExports['dynCall_iiiiiiiiii'];
		dynCall_viiiiii = wasmExports['Fb'];
		dynCall_viidii = wasmExports['Gb'];
	...
	var wasmImports = {
		C: ___assert_fail,
		_: ___call_sighandler,
		V: ___syscall__newselect,
		N: ___syscall_accept4,
		M: ___syscall_bind,
		ua: ___syscall_chdir,
		ta: ___syscall_chmod,
		L: ___syscall_connect,
		sa: ___syscall_dup,
		ra: ___syscall_dup3,
		...
		J: ___syscall_getpeername,
		I: ___syscall_getsockname,
		H: ___syscall_getsockopt,
		ya: ___syscall_ioctl,
		G: ___syscall_listen,
		...
		T: ___syscall_symlinkat,
		R: ___syscall_unlinkat,
		Q: ___syscall_utimensat,
		aa: __abort_js,
		...
		wa: _proc_exit,
		Da: _strptime,
		Ba: _vrzno_del_callback,
		Ca: _vrzno_exec_callback,
		D: _wasm_poll_socket,
		m: _wasm_setsockopt,
	};
