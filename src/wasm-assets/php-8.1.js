export const dependenciesTotalSize = 3563256;
export const dependencyFilename =
	'php-8.1.wasm?d615159758ede122b6e2e5978d80d217';
export default function (RuntimeName, PHPLoader, EnvVariables) {
	...
	var ___wasm_call_ctors = function () {
		return (___wasm_call_ctors = Module['asm']['Ua']).apply(
			null,
			arguments
		);
	};
	...
	var _fflush = (Module['_fflush'] = function () {
		return (_fflush = Module['_fflush'] = Module['asm']['bb']).apply(
			null,
			arguments
		);
	});
	...
	var _emscripten_builtin_memalign = function () {
		return (_emscripten_builtin_memalign = Module['asm']['Db']).apply(
			null,
			arguments
		);
	};
	var __emscripten_timeout = function () {
		return (__emscripten_timeout = Module['asm']['Eb']).apply(
			null,
			arguments
		);
	};
