export const dependenciesTotalSize = 4614816;
export const dependencyFilename =
	'php-7.4.wasm?fce78f0bcd880211c6d9cb45b66b35fd';
export default function (RuntimeName, PHPLoader, EnvVariables) {
	...
	function assignWasmExports(wasmExports) {
		...
		dynCall_viii = wasmExports['zb'];
		dynCall_vii = wasmExports['Ab'];
		dynCall_iii = wasmExports['Bb'];
		dynCall_viiiii = wasmExports['Cb'];
		dynCall_iiiiiii = wasmExports['Db'];
		dynCall_i = wasmExports['Eb'];
		dynCall_v = wasmExports['Fb'];
		dynCall_viiii = wasmExports['Gb'];
