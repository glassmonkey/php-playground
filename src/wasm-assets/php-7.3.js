export const dependenciesTotalSize = 3717589;
export const dependencyFilename =
	'php-7.3.wasm?a3d7fbbb3afd9d12235644ecdef7a04b';
export default function (RuntimeName, PHPLoader, EnvVariables) {
	...
	var ___wasm_call_ctors = function () {
		return (___wasm_call_ctors = Module['asm']['La']).apply(
			null,
			arguments
		);
	};
	...
	var ___errno_location = function () {
		return (___errno_location = Module['asm']['Na']).apply(null, arguments);
	};
	...
	var _htons = function () {
		return (_htons = Module['asm']['Va']).apply(null, arguments);
	};
	var _ntohs = function () {
		return (_ntohs = Module['asm']['Wa']).apply(null, arguments);
	};
	var _htonl = function () {
		return (_htonl = Module['asm']['Xa']).apply(null, arguments);
	};
	...
	var _emscripten_builtin_memalign = function () {
		return (_emscripten_builtin_memalign = Module['asm']['ub']).apply(
			null,
			arguments
		);
	};
	var __emscripten_timeout = function () {
		return (__emscripten_timeout = Module['asm']['vb']).apply(
			null,
			arguments
		);
	};
	...
	var dynCall_vi = (Module['dynCall_vi'] = function () {
		return (dynCall_vi = Module['dynCall_vi'] = Module['asm']['Ab']).apply(
			null,
			arguments
		);
	});
	...
	var dynCall_ii = (Module['dynCall_ii'] = function () {
		return (dynCall_ii = Module['dynCall_ii'] = Module['asm']['Eb']).apply(
			null,
			arguments
		);
	});
