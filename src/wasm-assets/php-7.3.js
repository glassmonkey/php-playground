export const dependenciesTotalSize = 3718370;
export const dependencyFilename =
	'php-7.3.wasm?194ff3ae4b09450ddf46243b6d9e94ab';
export default function (RuntimeName, PHPLoader, EnvVariables) {
	...
	var ___wasm_call_ctors = function () {
		return (___wasm_call_ctors = Module['asm']['Na']).apply(
			null,
			arguments
		);
	};
	...
	var ___errno_location = function () {
		return (___errno_location = Module['asm']['Pa']).apply(null, arguments);
	};
	...
	var _fflush = (Module['_fflush'] = function () {
		return (_fflush = Module['_fflush'] = Module['asm']['Wa']).apply(
			null,
			arguments
		);
	});
	...
	var _ntohs = function () {
		return (_ntohs = Module['asm']['Ya']).apply(null, arguments);
	};
	var _htonl = function () {
	...
	var _emscripten_builtin_memalign = function () {
		return (_emscripten_builtin_memalign = Module['asm']['wb']).apply(
			null,
			arguments
		);
	};
	var __emscripten_timeout = function () {
		return (__emscripten_timeout = Module['asm']['xb']).apply(
			null,
			arguments
		);
	};
	...
	var dynCall_vi = (Module['dynCall_vi'] = function () {
		return (dynCall_vi = Module['dynCall_vi'] = Module['asm']['Cb']).apply(
			null,
			arguments
		);
	});
	...
	var dynCall_ii = (Module['dynCall_ii'] = function () {
		return (dynCall_ii = Module['dynCall_ii'] = Module['asm']['Gb']).apply(
			null,
			arguments
		);
	});
	...
	var dynCall_i = (Module['dynCall_i'] = function () {
		return (dynCall_i = Module['dynCall_i'] = Module['asm']['Mb']).apply(
			null,
			arguments
		);
	});
	var dynCall_v = (Module['dynCall_v'] = function () {
		return (dynCall_v = Module['dynCall_v'] = Module['asm']['Nb']).apply(
			null,
			arguments
		);
	});
