export const dependenciesTotalSize = 4249583;
export const dependencyFilename =
	'php-7.0.wasm?41949bdb4ee6273b6e2301e90de941cd';
export default function (RuntimeName, PHPLoader, EnvVariables) {
	...
	function assignWasmExports(wasmExports) {
		_wasm_popen = Module['_wasm_popen'] = wasmExports['Ja'];
		_wasm_pclose = Module['_wasm_pclose'] = wasmExports['Ka'];
		_php_pollfd_for = Module['_php_pollfd_for'] = wasmExports['La'];
		_malloc = wasmExports['Na'];
		_ntohs = wasmExports['Oa'];
		...
		_wasm_set_content_length = Module['_wasm_set_content_length'] =
			wasmExports['bb'];
		_wasm_set_cookies = Module['_wasm_set_cookies'] = wasmExports['cb'];
		_wasm_set_php_code = Module['_wasm_set_php_code'] = wasmExports['db'];
		...
		_exec_callback = Module['_exec_callback'] = wasmExports['kb'];
		_del_callback = Module['_del_callback'] = wasmExports['lb'];
		___funcs_on_exit = wasmExports['mb'];
		_emscripten_builtin_memalign = wasmExports['nb'];
		__emscripten_timeout = wasmExports['ob'];
		_setThrew = wasmExports['pb'];
		__emscripten_stack_restore = wasmExports['qb'];
		__emscripten_stack_alloc = wasmExports['rb'];
		_emscripten_stack_get_current = wasmExports['sb'];
		dynCall_viii = wasmExports['tb'];
		dynCall_vii = wasmExports['ub'];
		dynCall_vi = wasmExports['vb'];
		dynCall_iii = wasmExports['wb'];
		dynCall_ii = wasmExports['xb'];
		dynCall_v = wasmExports['yb'];
		dynCall_iiii = wasmExports['zb'];
		dynCall_viiiii = wasmExports['Ab'];
		dynCall_iiiii = wasmExports['Bb'];
		dynCall_iiiiiii = wasmExports['Cb'];
		dynCall_iiiiii = wasmExports['dynCall_iiiiii'];
		dynCall_i = wasmExports['Db'];
		dynCall_viiii = wasmExports['Eb'];
		dynCall_iiiiiiiii = wasmExports['Fb'];
		dynCall_viiiiiiii = wasmExports['dynCall_viiiiiiii'];
		dynCall_iiiiiiiiii = wasmExports['dynCall_iiiiiiiiii'];
		dynCall_viiiiii = wasmExports['Gb'];
	...
	var wasmImports = {
		...
		U: ___syscall__newselect,
		M: ___syscall_accept4,
		L: ___syscall_bind,
		ta: ___syscall_chdir,
		sa: ___syscall_chmod,
		K: ___syscall_connect,
		ra: ___syscall_dup,
		qa: ___syscall_dup3,
		ua: ___syscall_faccessat,
		z: ___syscall_fchownat,
		...
		W: ___syscall_renameat,
		V: ___syscall_rmdir,
		D: ___syscall_sendto,
		t: ___syscall_socket,
		oa: ___syscall_stat64,
		T: ___syscall_statfs64,
		S: ___syscall_symlinkat,
		Q: ___syscall_unlinkat,
		P: ___syscall_utimensat,
		$: __abort_js,
		J: __emscripten_lookup_name,
		_: __emscripten_runtime_keepalive_clear,
		...
		va: _proc_exit,
		Ca: _strptime,
		Aa: _vrzno_del_callback,
		Ba: _vrzno_exec_callback,
		C: _wasm_poll_socket,
		o: _wasm_setsockopt,
	};
