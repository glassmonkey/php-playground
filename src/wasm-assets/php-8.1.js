export const dependenciesTotalSize = 4391612;
export const dependencyFilename =
	'php-8.1.wasm?52db020cd1e3f822fb1edf4de6e62f9d';
export default function (RuntimeName, PHPLoader, EnvVariables) {
	...
	function assignWasmExports(wasmExports) {
		_wasm_popen = Module['_wasm_popen'] = wasmExports['Ra'];
		_wasm_pclose = Module['_wasm_pclose'] = wasmExports['Sa'];
		_php_pollfd_for = Module['_php_pollfd_for'] = wasmExports['Ta'];
		_malloc = wasmExports['Va'];
		_fflush = wasmExports['Wa'];
		_htons = wasmExports['Xa'];
		_ntohs = wasmExports['Ya'];
		_htonl = wasmExports['Za'];
		...
		_exec_callback = Module['_exec_callback'] = wasmExports['tb'];
		_del_callback = Module['_del_callback'] = wasmExports['ub'];
		___funcs_on_exit = wasmExports['vb'];
		_emscripten_builtin_memalign = wasmExports['wb'];
		__emscripten_timeout = wasmExports['xb'];
		_setThrew = wasmExports['yb'];
		__emscripten_stack_restore = wasmExports['zb'];
		__emscripten_stack_alloc = wasmExports['Ab'];
		_emscripten_stack_get_current = wasmExports['Bb'];
		memory = wasmMemory = wasmExports['Pa'];
		__indirect_function_table = wasmTable = wasmExports['Ua'];
	}
	var wasmImports = {
		x: ___assert_fail,
