export const dependenciesTotalSize = 4554432;
export const dependencyFilename =
	'php-8.0.wasm?6262e88d852e81be84875c919684bd38';
export default function (RuntimeName, PHPLoader, EnvVariables) {
	...
	function assignWasmExports(wasmExports) {
		_wasm_popen = Module['_wasm_popen'] = wasmExports['La'];
		_wasm_pclose = Module['_wasm_pclose'] = wasmExports['Ma'];
		_php_pollfd_for = Module['_php_pollfd_for'] = wasmExports['Na'];
		_malloc = wasmExports['Pa'];
		_fflush = wasmExports['Qa'];
		_htons = wasmExports['Ra'];
		_ntohs = wasmExports['Sa'];
		_htonl = wasmExports['Ta'];
		...
		_exec_callback = Module['_exec_callback'] = wasmExports['nb'];
		_del_callback = Module['_del_callback'] = wasmExports['ob'];
		___funcs_on_exit = wasmExports['pb'];
		_emscripten_builtin_memalign = wasmExports['qb'];
		__emscripten_timeout = wasmExports['rb'];
		_setThrew = wasmExports['sb'];
		__emscripten_stack_restore = wasmExports['tb'];
		__emscripten_stack_alloc = wasmExports['ub'];
	...
	var wasmImports = {
		s: ___assert_fail,
		$: ___call_sighandler,
		W: ___syscall__newselect,
		O: ___syscall_accept4,
		N: ___syscall_bind,
		ua: ___syscall_chdir,
		ta: ___syscall_chmod,
		M: ___syscall_connect,
		ra: ___syscall_dup,
		qa: ___syscall_dup3,
		...
		_: ___syscall_getdents64,
		K: ___syscall_getpeername,
		J: ___syscall_getsockname,
		I: ___syscall_getsockopt,
		v: ___syscall_ioctl,
		H: ___syscall_listen,
		...
		V: ___syscall_statfs64,
		U: ___syscall_symlinkat,
		S: ___syscall_unlinkat,
		R: ___syscall_utimensat,
		wa: __abort_js,
		L: __emscripten_lookup_name,
